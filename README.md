...
- **My Implementations**: This is the main folder which includes the following subfolder + files:
  ...
  - **graphdata.py**: This file is a python script which delimits, segregates and averages the output obtained from a .txt file after running the key exchange from the python script in 'My Implementations.'
